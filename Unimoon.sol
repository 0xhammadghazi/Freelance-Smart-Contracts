...
contract UNIMOON is Ownable {
    ...
    mapping (address => uint256) private icoBuyersContribution;
    mapping (address => uint256) private icoBuyersReserves;
    ...
    function reserveTokens() external payable {
        ...
        uint amount = (msg.value * unimoonICOPrice)/1000000000;
